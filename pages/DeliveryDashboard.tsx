...
export const DeliveryDashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col overflow-y-auto px-4 py-4 bg-[#080e1a] text-white font-sans overflow-x-hidden">
      <div className="w-full max-w-md mx-auto">
        ...
        {/* Header */}
        <div className="relative z-20 bg-black/40 backdrop-blur-xl border border-white/5 rounded-2xl px-4 py-4 mb-4">
        ...
        <div className="relative z-10 space-y-3 pb-8">
          <div className="flex items-center justify-between mb-2">
            <h2 className="text-xs font-black text-orange-300/60 uppercase tracking-widest px-1">
                  ...
                  <div className="border-t border-white/5 p-4 space-y-4 animate-fade-in">
                    ...
                    {order.address && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="w-full flex items-center justify-center gap-2 text-xs font-bold text-orange-400 bg-orange-500/10 px-4 py-2.5 rounded-xl border border-orange-500/20 hover:bg-orange-500/15 transition-all active:scale-95"
                      >
